                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td colspan="4" align="center">
                                                            <h3 style="color:red">Không lưu lại dữ liệu</h3>
                                                        </td>
                                                    </tr>
                                                <?php 
                                                } else {
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="trash-posts.php?pid=<?php echo htmlentities($row['postid']);?>&&action=restore" onclick="return confirm('Do you really want to restore ?')">
