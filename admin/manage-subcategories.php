...
<html lang="en">
    <head>
        ...
        <title> News | Danh sách danh mục chi tiết</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Danh sách danh mục chi tiết</h4>
                                    ...
                                    <div class="row">
										<div class="col-md-12">
											<div class="demo-box m-t-20">
                                                ...
                                                <button id="addToTable" class="btn btn-success waves-effect waves-light">Thêm danh mục chi tiết<i class="mdi mdi-plus-circle-outline" ></i></button>
                                                </a>
                                                </div>
