    ...
    <div class="container">
        <div class="row" style="margin-top: 4%">
            <div class="col-md-8">
                ...
                // Initialize a variable to keep track of whether category name is displayed
                ...
                if ($rowcount == 0) {
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        // Display category name only if it hasn't been displayed yet
                        if (!$categoryDisplayed) {
                            echo "<h1>" . htmlentities($row['category']) . " News</h1>";
                            // Set the flag to true to indicate that category name has been displayed
